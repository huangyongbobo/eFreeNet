...
def parse_args():
    ...
    parser.add_argument('--lr2', type=float, default=0.01, help='the initial learning rate of learners')
    ...
    parser.add_argument('--ensemble_num', type=int, default=8, help='number of learners of ensemble learning')
